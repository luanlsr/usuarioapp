...
namespace UsuariosApp.API.Middlewares
{
    public class ExceptionMiddleware
    {
        ...
        public async Task HandleExceptionAsync(HttpContext context, Exception exception) 
        {
            ...
            {
                EmailJaCadastradoException => (int)HttpStatusCode.BadRequest,
                AcessoNegadoException => (int)HttpStatusCode.Unauthorized,
                UsuarioNaoEncontradoException => (int)HttpStatusCode.NotFound,
